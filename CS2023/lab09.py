...
def slice_link(link, start, end):
    ...
    nextta = b.rest
    for _ in range(end-2-start): # -2 due to previous line of code
      nextta = nextta.rest
...
def magic_test():
  ...
  # Could be switched to true to ensure that the program was running the doctests
  # without any issues (showing tests are passed/failed)
